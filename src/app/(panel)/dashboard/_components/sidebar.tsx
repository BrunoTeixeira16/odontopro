...
import { Banknote, CalendarCheck2, ChevronLeft, ChevronRight, Folder, List, Settings, PackageSearch } from "lucide-react";
    ...
    return (
        <div className="flex min-h-screen w-full">
            ...
            <aside className={clsx("flex flex-col border-r bg-background transition-all duration-300 p-4 h-full", {
                ...
                {/* Mostrar icones quando a sidebar estiver recolhida */}
                {isCollapsed && (
            ...
            <div className={clsx("flex flex-1 flex-col transition-all duration-300", {
                ...
                <header className="md:hidden flex items-center justify-between border-b drop-shadow-sm px-4 md:px-6 h-14 z-10 sticky top-0 bg-white">
                    <Sheet>
                        <div className="flex items-center gap-4">
                            ...
                            <h1 className="text-base md:text-lg font-semibold">Menu Odonto<span className="text-emerald-500">PRO</span></h1>
                        </div>

                        <SheetContent side="left" className="sm:max-w-xs text-black">
                            <SheetTitle>Odonto<span className="text-emerald-500">PRO</span></SheetTitle>
                            <SheetDescription>
                                Menu Administrativo
                            </SheetDescription>
