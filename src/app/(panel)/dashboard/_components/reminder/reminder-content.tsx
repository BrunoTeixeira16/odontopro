        ...
        <div className="grid gap-4 py-4">
            <Form {...form}>
                <form className="flex flex-col gap-4" onSubmit={form.handleSubmit(onSubmit)}>
                    <FormField 
                        ...
                        render={({field}) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Textarea {...field} placeholder="Digite a descrição do lembrete..." className="max-h-52"/>
                                </FormControl>
                                <FormMessage/>
                            </FormItem>
                        )}
                    ...
                    <Button type="submit" disabled={!form.watch("description")} className={cn(!form.watch("description") && "cursor-not-allowed")}>Cadastrar lembrete</Button>
                </form>
            </Form>
        </div>
    )
