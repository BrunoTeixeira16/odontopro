...
export function AvatarProfile({ avatarUrl, userId }: AvatarProfileProps) {
    ...
    async function handleChange(e: ChangeEvent<HTMLInputElement>) {
        ...
        if (e.target.files && e.target.files[0]) {
            ...
            if (!urlImage || urlImage === "") {
                toast.error("Ocorreu um erro ao alterar a imagem.");
                return;
            }
    ...
    async function uploadImage(image: File): Promise<string | null> {
        ...
        try {
            ...
            toast.loading("Enviando sua imagem...");
    ...
    return (
        <div className="relative w-40 h-40 md:w-48 md:h-48">
            ...
            <div className="relative flex items-center justify-center w-full h-full">
                ...
                <input type="file" className="opacity-0 cursor-pointer relative z-50 w-48 h-48 " onChange={handleChange}/>
            </div>
