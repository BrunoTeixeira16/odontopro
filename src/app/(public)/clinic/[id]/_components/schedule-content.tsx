...
export function ScheduleContent({clinic}: ScheduleContentProps) {
    ...
    // Função que busca os horários bloqueados
            ...
            <section className="max-w-2xl mx-auto w-full mt-6">
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(handleRegisterAppointment)} className="mx-2 space-y-6 bg-white p-6 border rounded-md shadow-sm">
                        ...
                        <FormField 
                            ...
                            render={ ({field}) => (
                                <FormItem className="flex items-center gap-2 space-y-1">
                                    ...
                                    <FormControl>
                                        <DateTimePicker initialDate={new Date()} className="w-full rounded border p-2" onChange={(date) => {
                                            if (date) {
                                                field.onChange(date)
                                                setSelectedTime("")
                                            }
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="bg-gray-100 p-4 rounded-lg">
                                    {loadingSlots ? (                                        
                                        ...
                                        <p>Nenhum horário dísponivel no momento...</p>
                                    ) : (
                                        <ScheduleTimeList 
                        ...
                        {clinic.status ? (
                            <Button type="submit" className="w-full bg-emerald-500 hover:bg-emerald-400" disabled={!watch("name") || !watch("email") || !watch("phone") || !watch("date") || !watch("serviceId")}>
